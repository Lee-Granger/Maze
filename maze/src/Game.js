...
Ball.Game.prototype = {
    create: function(){
        ...
        this.timer = 0; // time elapsed in current level
        this.totalTimer = 0; //time elapsed in game overall
    ...
    managePause: function(){
        ...
        var pausedText = this.add.text(Ball._WIDTH*0.5, 250, "Game Paused,/ntap anywhere to continue.", this.fontMessage);
    ...
    manageAudio: function(){
        ...
        this.audioButton.animation.play(this.audioStatus);
    },
